...
func SetupTestDB(t *testing.T, migrationsFiles fs.FS) (postgres.Querier, func()) {
	return setupTestDBWithName(t, t.Name(), migrationsFiles)
}

func setupTestDBWithName(t *testing.T, name string, migrationsFiles fs.FS) (postgres.Querier, func()) {
	t.Helper()
	if testing.Short() {
